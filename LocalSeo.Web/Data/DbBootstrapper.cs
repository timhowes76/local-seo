...
END;
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'Key') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD [Key] nvarchar(100) NOT NULL CONSTRAINT DF_ApiStatusCheckDefinition_Key_Alt DEFAULT(N'');
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'DisplayName') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD DisplayName nvarchar(200) NOT NULL CONSTRAINT DF_ApiStatusCheckDefinition_DisplayName_Alt DEFAULT(N'');
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'Category') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD Category nvarchar(100) NOT NULL CONSTRAINT DF_ApiStatusCheckDefinition_Category_Alt DEFAULT(N'');
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'IsEnabled') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD IsEnabled bit NOT NULL CONSTRAINT DF_ApiStatusCheckDefinition_IsEnabled_Alt DEFAULT(1);
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'IntervalSeconds') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD IntervalSeconds int NOT NULL CONSTRAINT DF_ApiStatusCheckDefinition_IntervalSeconds_Alt DEFAULT(300);
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'TimeoutSeconds') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD TimeoutSeconds int NOT NULL CONSTRAINT DF_ApiStatusCheckDefinition_TimeoutSeconds_Alt DEFAULT(10);
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'DegradedThresholdMs') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD DegradedThresholdMs int NULL;
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'CreatedUtc') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD CreatedUtc datetime2(3) NOT NULL CONSTRAINT DF_ApiStatusCheckDefinition_CreatedUtc_Alt DEFAULT SYSUTCDATETIME();
IF COL_LENGTH('dbo.ApiStatusCheckDefinition', 'UpdatedUtc') IS NULL
  ALTER TABLE dbo.ApiStatusCheckDefinition ADD UpdatedUtc datetime2(3) NOT NULL CONSTRAINT DF_ApiStatusCheckDefinition_UpdatedUtc_Alt DEFAULT SYSUTCDATETIME();
...
END;
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'DefinitionId') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD DefinitionId int NOT NULL CONSTRAINT DF_ApiStatusCheckResult_DefinitionId_Alt DEFAULT(0);
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'CheckedUtc') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD CheckedUtc datetime2(3) NOT NULL CONSTRAINT DF_ApiStatusCheckResult_CheckedUtc_Alt DEFAULT SYSUTCDATETIME();
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'Status') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD [Status] tinyint NOT NULL CONSTRAINT DF_ApiStatusCheckResult_Status_Alt DEFAULT(0);
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'LatencyMs') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD LatencyMs int NULL;
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'Message') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD [Message] nvarchar(500) NULL;
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'DetailsJson') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD DetailsJson nvarchar(max) NULL;
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'HttpStatusCode') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD HttpStatusCode int NULL;
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'ErrorType') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD ErrorType nvarchar(200) NULL;
IF COL_LENGTH('dbo.ApiStatusCheckResult', 'ErrorMessage') IS NULL
  ALTER TABLE dbo.ApiStatusCheckResult ADD ErrorMessage nvarchar(1000) NULL;
IF NOT EXISTS (
  SELECT 1
  ...
  ALTER TABLE dbo.ApiStatusCheckResult WITH CHECK ADD CONSTRAINT FK_ApiStatusCheckResult_Definition FOREIGN KEY (DefinitionId) REFERENCES dbo.ApiStatusCheckDefinition(Id);
...
END;
IF COL_LENGTH('dbo.PlaceRunReports', 'PlaceId') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD PlaceId nvarchar(128) NOT NULL CONSTRAINT DF_PlaceRunReports_PlaceId_Alt DEFAULT(N'');
IF COL_LENGTH('dbo.PlaceRunReports', 'RunId') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD RunId bigint NOT NULL CONSTRAINT DF_PlaceRunReports_RunId_Alt DEFAULT(0);
IF COL_LENGTH('dbo.PlaceRunReports', 'ReportType') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD ReportType nvarchar(50) NOT NULL CONSTRAINT DF_PlaceRunReports_ReportType_Alt DEFAULT(N'FirstContactOnePager');
IF COL_LENGTH('dbo.PlaceRunReports', 'Variant') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD Variant nvarchar(20) NOT NULL CONSTRAINT DF_PlaceRunReports_Variant_Alt DEFAULT(N'ClientFacing');
IF COL_LENGTH('dbo.PlaceRunReports', 'Version') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD Version int NOT NULL CONSTRAINT DF_PlaceRunReports_Version_Alt DEFAULT(1);
IF COL_LENGTH('dbo.PlaceRunReports', 'HtmlSnapshotPath') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD HtmlSnapshotPath nvarchar(260) NULL;
IF COL_LENGTH('dbo.PlaceRunReports', 'PdfPath') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD PdfPath nvarchar(260) NULL;
IF COL_LENGTH('dbo.PlaceRunReports', 'CreatedUtc') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD CreatedUtc datetime2(3) NOT NULL CONSTRAINT DF_PlaceRunReports_CreatedUtc_Alt DEFAULT SYSUTCDATETIME();
IF COL_LENGTH('dbo.PlaceRunReports', 'CreatedByUserId') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD CreatedByUserId int NULL;
IF COL_LENGTH('dbo.PlaceRunReports', 'ContentHash') IS NULL
  ALTER TABLE dbo.PlaceRunReports ADD ContentHash nvarchar(64) NULL;
...
END;
IF COL_LENGTH('dbo.SeoAuditRule', 'RuleKey') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD RuleKey nvarchar(120) NOT NULL CONSTRAINT DF_SeoAuditRule_RuleKey DEFAULT(N'');
IF COL_LENGTH('dbo.SeoAuditRule', 'Name') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD [Name] nvarchar(200) NOT NULL CONSTRAINT DF_SeoAuditRule_Name DEFAULT(N'');
IF COL_LENGTH('dbo.SeoAuditRule', 'Description') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD [Description] nvarchar(1000) NULL;
IF COL_LENGTH('dbo.SeoAuditRule', 'RuleGroup') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD RuleGroup nvarchar(100) NULL;
IF COL_LENGTH('dbo.SeoAuditRule', 'RuleMode') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD RuleMode nvarchar(40) NOT NULL CONSTRAINT DF_SeoAuditRule_RuleMode_Alt DEFAULT(N'Fixed');
IF COL_LENGTH('dbo.SeoAuditRule', 'RuleType') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD RuleType nvarchar(80) NOT NULL CONSTRAINT DF_SeoAuditRule_RuleType DEFAULT(N'MissingField');
IF COL_LENGTH('dbo.SeoAuditRule', 'EntityType') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD EntityType nvarchar(40) NOT NULL CONSTRAINT DF_SeoAuditRule_EntityType DEFAULT(N'GBP_PROFILE');
IF COL_LENGTH('dbo.SeoAuditRule', 'Severity') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD Severity nvarchar(40) NOT NULL CONSTRAINT DF_SeoAuditRule_Severity_Alt DEFAULT(N'Warning');
IF COL_LENGTH('dbo.SeoAuditRule', 'WarningScoreImpact') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD WarningScoreImpact int NOT NULL CONSTRAINT DF_SeoAuditRule_WarningScoreImpact_Alt DEFAULT(0);
IF COL_LENGTH('dbo.SeoAuditRule', 'FailScoreImpact') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD FailScoreImpact int NOT NULL CONSTRAINT DF_SeoAuditRule_FailScoreImpact_Alt DEFAULT(0);
IF COL_LENGTH('dbo.SeoAuditRule', 'SortOrder') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD SortOrder int NOT NULL CONSTRAINT DF_SeoAuditRule_SortOrder_Alt DEFAULT(0);
IF COL_LENGTH('dbo.SeoAuditRule', 'IsActive') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD IsActive bit NOT NULL CONSTRAINT DF_SeoAuditRule_IsActive_Alt DEFAULT(1);
IF COL_LENGTH('dbo.SeoAuditRule', 'ShowInActionsTab') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD ShowInActionsTab bit NOT NULL CONSTRAINT DF_SeoAuditRule_ShowInActionsTab_Alt DEFAULT(1);
IF COL_LENGTH('dbo.SeoAuditRule', 'WhyItMattersText') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD WhyItMattersText nvarchar(max) NULL;
IF COL_LENGTH('dbo.SeoAuditRule', 'RecommendedActionText') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD RecommendedActionText nvarchar(max) NULL;
IF COL_LENGTH('dbo.SeoAuditRule', 'CreatedAtUtc') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD CreatedAtUtc datetime2(0) NOT NULL CONSTRAINT DF_SeoAuditRule_CreatedAtUtc_Alt DEFAULT SYSUTCDATETIME();
IF COL_LENGTH('dbo.SeoAuditRule', 'UpdatedAtUtc') IS NULL
  ALTER TABLE dbo.SeoAuditRule ADD UpdatedAtUtc datetime2(0) NOT NULL CONSTRAINT DF_SeoAuditRule_UpdatedAtUtc_Alt DEFAULT SYSUTCDATETIME();
...
END;
IF COL_LENGTH('dbo.SeoAuditRuleParameter', 'SeoAuditRuleId') IS NULL
  ALTER TABLE dbo.SeoAuditRuleParameter ADD SeoAuditRuleId bigint NOT NULL CONSTRAINT DF_SeoAuditRuleParameter_SeoAuditRuleId DEFAULT(0);
IF COL_LENGTH('dbo.SeoAuditRuleParameter', 'ParameterName') IS NULL
  ALTER TABLE dbo.SeoAuditRuleParameter ADD ParameterName nvarchar(120) NOT NULL CONSTRAINT DF_SeoAuditRuleParameter_ParameterName DEFAULT(N'');
IF COL_LENGTH('dbo.SeoAuditRuleParameter', 'ParameterValue') IS NULL
  ALTER TABLE dbo.SeoAuditRuleParameter ADD ParameterValue nvarchar(4000) NOT NULL CONSTRAINT DF_SeoAuditRuleParameter_ParameterValue DEFAULT(N'');
IF COL_LENGTH('dbo.SeoAuditRuleParameter', 'ValueType') IS NULL
  ALTER TABLE dbo.SeoAuditRuleParameter ADD ValueType nvarchar(30) NOT NULL CONSTRAINT DF_SeoAuditRuleParameter_ValueType_Alt DEFAULT(N'String');
IF COL_LENGTH('dbo.SeoAuditRuleParameter', 'SortOrder') IS NULL
  ALTER TABLE dbo.SeoAuditRuleParameter ADD SortOrder int NOT NULL CONSTRAINT DF_SeoAuditRuleParameter_SortOrder_Alt DEFAULT(0);
IF COL_LENGTH('dbo.SeoAuditRuleParameter', 'IsActive') IS NULL
  ALTER TABLE dbo.SeoAuditRuleParameter ADD IsActive bit NOT NULL CONSTRAINT DF_SeoAuditRuleParameter_IsActive_Alt DEFAULT(1);
IF NOT EXISTS (
  SELECT 1
  FROM sys.foreign_key_columns fkc
  JOIN sys.columns pc ON pc.object_id = fkc.parent_object_id AND pc.column_id = fkc.parent_column_id
  ...
  WHERE fkc.parent_object_id = OBJECT_ID('dbo.SeoAuditRuleParameter')
    ...
    AND pc.name = 'SeoAuditRuleId'
    AND rc.name = 'SeoAuditRuleId'
)
...
END;
IF COL_LENGTH('dbo.SeoAuditResult', 'PlaceId') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD PlaceId nvarchar(128) NOT NULL CONSTRAINT DF_SeoAuditResult_PlaceId DEFAULT(N'');
IF COL_LENGTH('dbo.SeoAuditResult', 'SeoAuditRuleId') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD SeoAuditRuleId bigint NOT NULL CONSTRAINT DF_SeoAuditResult_SeoAuditRuleId DEFAULT(0);
IF COL_LENGTH('dbo.SeoAuditResult', 'Status') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD [Status] nvarchar(30) NOT NULL CONSTRAINT DF_SeoAuditResult_Status DEFAULT(N'NotApplicable');
IF COL_LENGTH('dbo.SeoAuditResult', 'ScoreImpactApplied') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD ScoreImpactApplied int NOT NULL CONSTRAINT DF_SeoAuditResult_ScoreImpactApplied_Alt DEFAULT(0);
IF COL_LENGTH('dbo.SeoAuditResult', 'ActualValue') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD ActualValue nvarchar(1000) NULL;
IF COL_LENGTH('dbo.SeoAuditResult', 'ExpectedValue') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD ExpectedValue nvarchar(1000) NULL;
IF COL_LENGTH('dbo.SeoAuditResult', 'GapValue') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD GapValue nvarchar(1000) NULL;
IF COL_LENGTH('dbo.SeoAuditResult', 'SummaryText') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD SummaryText nvarchar(2000) NULL;
IF COL_LENGTH('dbo.SeoAuditResult', 'WhyItMattersText') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD WhyItMattersText nvarchar(max) NULL;
IF COL_LENGTH('dbo.SeoAuditResult', 'RecommendedActionText') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD RecommendedActionText nvarchar(max) NULL;
IF COL_LENGTH('dbo.SeoAuditResult', 'SortOrderSnapshot') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD SortOrderSnapshot int NOT NULL CONSTRAINT DF_SeoAuditResult_SortOrderSnapshot_Alt DEFAULT(0);
IF COL_LENGTH('dbo.SeoAuditResult', 'LastSourceSearchRunId') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD LastSourceSearchRunId bigint NULL;
IF COL_LENGTH('dbo.SeoAuditResult', 'LastEvaluatedAtUtc') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD LastEvaluatedAtUtc datetime2(0) NOT NULL CONSTRAINT DF_SeoAuditResult_LastEvaluatedAtUtc_Alt DEFAULT SYSUTCDATETIME();
IF COL_LENGTH('dbo.SeoAuditResult', 'CreatedAtUtc') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD CreatedAtUtc datetime2(0) NOT NULL CONSTRAINT DF_SeoAuditResult_CreatedAtUtc_Alt DEFAULT SYSUTCDATETIME();
IF COL_LENGTH('dbo.SeoAuditResult', 'UpdatedAtUtc') IS NULL
  ALTER TABLE dbo.SeoAuditResult ADD UpdatedAtUtc datetime2(0) NOT NULL CONSTRAINT DF_SeoAuditResult_UpdatedAtUtc_Alt DEFAULT SYSUTCDATETIME();
IF NOT EXISTS (
  SELECT 1
  FROM sys.foreign_key_columns fkc
  JOIN sys.columns pc ON pc.object_id = fkc.parent_object_id AND pc.column_id = fkc.parent_column_id
...
IF OBJECT_ID('dbo.SearchRun','U') IS NOT NULL
  ...
  WHERE fkc.parent_object_id = OBJECT_ID('dbo.SeoAuditResult')
    AND fkc.referenced_object_id = OBJECT_ID('dbo.SearchRun')
    AND pc.name = 'LastSourceSearchRunId'
    AND rc.name = 'SearchRunId'
)
